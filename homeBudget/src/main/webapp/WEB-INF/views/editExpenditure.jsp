			...
			<div class="form-group">
				<label for="category">Kategoria</label> <label
					class="checkbox-inline"><form:radiobutton
						path="expenditureCategory" id="category" value="Daily" />Wydatki
					codzienne</label> <label class="checkbox-inline"><form:radiobutton
						path="expenditureCategory" id="category" value="Periodic" />Wydatki
					okresowe</label> <label class="checkbox-inline"><form:radiobutton
						path="expenditureCategory" id="category" value="Occasional" />Wydatki
					okazjonalne</label>
			</div>
			<div class="container">
				<div class="row">
